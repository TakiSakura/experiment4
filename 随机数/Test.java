...
public class Test {
    public static void main(String[] args) {
        ...
        System.out.println("学生" + stu1.name + "的收入:" + stu1.salary + "\t纳税:" + stu1.getTexes() + "\t实际收入为:" + stu1.texesSalary);
        System.out.println("学生" + stu2.name + "的收入:" + stu2.salary + "\t纳税:" + stu2.getTexes() + "\t实际收入为:" + stu2.texesSalary);
        System.out.println("学生" + stu3.name + "的收入:" + stu3.salary + "\t纳税:" + stu3.getTexes() + "\t实际收入为:" + stu3.texesSalary);
        System.out.println("学生" + stu4.name + "的收入:" + stu4.salary + "\t纳税:" + stu4.getTexes() + "\t实际收入为:" + stu4.texesSalary);
